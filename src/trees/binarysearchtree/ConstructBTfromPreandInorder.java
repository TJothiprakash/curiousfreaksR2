...
public class ConstructBTfromPreandInorder {
    ...
    public static void main(String[] args) {
        ...
        new ConstructBTfromPreandInorder().printVector(inorder);

        System.out.print("Preorder Vector: ");
        new ConstructBTfromPreandInorder().printVector(preorder);

        ConstructBTfromPreandInorder sol = new ConstructBTfromPreandInorder();
